...
@{
    ...
    FunctionsToExport = @('Add-SeDriverOptionsArgument', 'Clear-SeAlert', 'Get-SeCookie', 'Get-SeDriver', 'Get-SeElement', 'Get-SeElementAttribute', 'Get-SeElementCssValue', 'Get-SeKeys', 'Get-SeSelectionOption', 'Get-SeUrl', 'Get-SeWindow', 'New-SeDriverOptions', 'New-SeScreenshot', 'Pop-SeUrl', 'Push-SeUrl', 'Remove-SeCookie', 'Save-SeScreenshot', 'Select-SeDriver', 'Send-SeClick', 'Send-SeKeys', 'SeOpen', 'SeShouldHave', 'Set-SeCookie', 'Set-SeUrl', 'Start-SeDriver', 'Start-SeRemote', 'Stop-SeDriver', 'Switch-SeFrame', 'Switch-SeWindow')
    AliasesToExport      = @(
        'SeChrome' ,
        'SeFirefox',
